...
sampled_data_y = get_sax_emotions(sample_dominant_emotions, num_sax_segments)
...
sampled_data_train_x = np.take(sax_data[0], split_indeces, axis = 0)
sampled_data_train_y = np.take(sampled_data_y, split_indeces)

sampled_data_test_x = np.delete(sax_data[0], split_indeces, axis = 0)
